...
from .views import ImageAPIDetail, ImageAPIList, image_detail, addManyImages, add_images_via_json 
...
urlpatterns = [
    ...
    path('admin/images/image/add/upload-images/', add_images_via_json, name="upload_images"),
